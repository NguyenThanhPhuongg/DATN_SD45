...
VALUES
(1, 1, 1, N'Áo thun nam', N'ATN001', N'Trung Quốc', N'Áo thun nam chất lượng cao', 199.99, N'path_to_image1.jpg', 1, GETDATE(), GETDATE(), 1, 1),
(1, 1, 2, N'Quần jean nam', N'QJN001', N'Việt Nam', N'Quần jean nam, bền và thời trang', 250.00, N'path_to_image2.jpg', 1, GETDATE(), GETDATE(), 1, 1),
(2, 2, 1, N'Áo sơ mi nữ', N'ASN001', N'Việt Nam', N'Áo sơ mi nữ thanh lịch, phù hợp với công sở', 350.00, N'path_to_image3.jpg', 1, GETDATE(), GETDATE(), 1, 1),
(2, 3, 2, N'Áo khoác nam', N'AKN001', N'Hàn Quốc', N'Áo khoác nam dày, ấm áp cho mùa đông', 450.00, N'path_to_image4.jpg', 1, GETDATE(), GETDATE(), 1, 1),
(3, 1, 3, N'Váy đầm nữ', N'VDN001', N'Thái Lan', N'Váy đầm nữ đẹp, nhẹ nhàng cho mùa hè', 399.99, N'path_to_image5.jpg', 1, GETDATE(), GETDATE(), 1, 1);
GO
...
VALUES
(1, 1, 1, 50, 199.99, N'Áo thun màu đỏ, kích thước S', 1, GETDATE(), GETDATE(), 1, 1),
(1, 2, 2, 30, 199.99, N'Áo thun màu xanh, kích thước M', 1, GETDATE(), GETDATE(), 1, 1),
(2, 3, 3, 40, 250.00, N'Quần jean màu đen, kích thước L', 1, GETDATE(), GETDATE(), 1, 1),
(3, 2, 4, 20, 350.00, N'Áo sơ mi nữ màu trắng, kích thước M', 1, GETDATE(), GETDATE(), 1, 1),
(4, 3, 5, 10, 450.00, N'Áo khoác nam màu xanh, kích thước XL', 1, GETDATE(), GETDATE(), 1, 1);
GO
