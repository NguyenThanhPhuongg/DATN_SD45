...
VALUES 
(1, 1, 'Áo sơ mi nam', 'Việt Nam', 'Áo sơ mi nam chất cotton, thoáng mát', 'mangto.png', 1, 1, 1),
(1, 1, 'Áo thun nam', 'Việt Nam', 'Áo thun nam đơn giản, dễ phối đồ', 'mangto.png', 1, 1, 1),
(1, 2, 'Áo khoác nam', 'Việt Nam', 'Áo khoác nam thời trang, giữ ấm tốt', 'mangto.png', 1, 1, 1),
(1, 2, 'Áo len nam', 'Việt Nam', 'Áo len nam mềm mại, phù hợp mùa đông', 'mangto.png', 1, 1, 1),
(1, 3, 'Áo jacket nam', 'Việt Nam', 'Áo jacket nam cá tính, chất liệu da', 'mangto.png', 1, 1, 1),
(1, 3, 'Áo hoodie nam', 'Việt Nam', 'Áo hoodie nam năng động, tiện lợi', 'mangto.png', 1, 1, 1),
(1, 4, 'Áo polo nam', 'Việt Nam', 'Áo polo nam thanh lịch, dễ mặc', 'mangto.png', 1, 1, 1),
(1, 4, 'Áo tank top nam', 'Việt Nam', 'Áo tank top nam mát mẻ, thích hợp mùa hè', 'mangto.png', 1, 1, 1),
(1, 5, 'Áo thun cổ tròn nam', 'Việt Nam', 'Áo thun cổ tròn nam chất lượng', 'mangto.png', 1, 1, 1),
(1, 5, 'Áo sơ mi kẻ nam', 'Việt Nam', 'Áo sơ mi kẻ nam thời trang', 'mangto.png', 1, 1, 1),
(1, 1, 'Áo khoác denim nam', 'Việt Nam', 'Áo khoác denim nam bền bỉ', 'mangto.png', 1, 1, 1),
(1, 2, 'Áo sơ mi trắng nam', 'Việt Nam', 'Áo sơ mi trắng nam thanh lịch', 'mangto.png', 1, 1, 1),
(1, 3, 'Áo thun ôm nam', 'Việt Nam', 'Áo thun ôm nam thời trang', 'mangto.png', 1, 1, 1),
(1, 4, 'Áo khoác dạ nam', 'Việt Nam', 'Áo khoác dạ nam ấm áp', 'mangto.png', 1, 1, 1),
(1, 5, 'Áo phao nam', 'Việt Nam', 'Áo phao nam chống lạnh', 'mangto.png', 1, 1, 1);
GO
...
VALUES 
(1, 1, 1, 1, 50, 250000.00, 'Áo sơ mi nam màu đỏ, size S', 1, GETDATE(), GETDATE(), 1, 1),
(1, 2, 2, 1, 30, 260000.00, 'Áo sơ mi nam màu xanh, size M', 1, GETDATE(), GETDATE(), 1, 1),
(2, 1, 3, 2, 25, 200000.00, 'Áo thun nam màu vàng, size S', 1, GETDATE(), GETDATE(), 1, 1),
(2, 2, 4, 2, 20, 220000.00, 'Áo thun nam màu đen, size M', 1, GETDATE(), GETDATE(), 1, 1),
(3, 3, 5, 3, 15, 450000.00, 'Áo khoác nam màu trắng, size L', 1, GETDATE(), GETDATE(), 1, 1),
(3, 4, 6, 3, 10, 480000.00, 'Áo khoác nam màu xám, size XL', 1, GETDATE(), GETDATE(), 1, 1),
(4, 1, 7, 4, 50, 300000.00, 'Áo len nam màu nâu, size S', 1, GETDATE(), GETDATE(), 1, 1),
(4, 2, 8, 4, 45, 320000.00, 'Áo len nam màu hồng, size M', 1, GETDATE(), GETDATE(), 1, 1),
(5, 3, 9, 5, 40, 500000.00, 'Áo jacket nam màu xanh lá, size L', 1, GETDATE(), GETDATE(), 1, 1),
(5, 4, 10, 5, 35, 520000.00, 'Áo jacket nam màu tím, size XL', 1, GETDATE(), GETDATE(), 1, 1),
(6, 1, 1, 1, 50, 180000.00, 'Áo hoodie nam màu đỏ, size S', 1, GETDATE(), GETDATE(), 1, 1),
(6, 2, 2, 1, 30, 190000.00, 'Áo hoodie nam màu xanh, size M', 1, GETDATE(), GETDATE(), 1, 1),
(7, 3, 3, 2, 25, 150000.00, 'Áo polo nam màu vàng, size L', 1, GETDATE(), GETDATE(), 1, 1),
(7, 4, 4, 2, 20, 160000.00, 'Áo polo nam màu đen, size XL', 1, GETDATE(), GETDATE(), 1, 1),
(8, 1, 5, 3, 15, 200000.00, 'Áo tank top nam màu trắng, size S', 1, GETDATE(), GETDATE(), 1, 1),
(8, 2, 6, 3, 10, 220000.00, 'Áo tank top nam màu xám, size M', 1, GETDATE(), GETDATE(), 1, 1),
(9, 3, 7, 4, 50, 210000.00, 'Áo thun cổ tròn nam màu nâu, size L', 1, GETDATE(), GETDATE(), 1, 1),
(9, 4, 8, 4, 45, 230000.00, 'Áo thun cổ tròn nam màu hồng, size XL', 1, GETDATE(), GETDATE(), 1, 1),
(10, 1, 9, 5, 40, 240000.00, 'Áo khoác denim nam màu xanh lá, size S', 1, GETDATE(), GETDATE(), 1, 1),
(10, 2, 10, 5, 35, 260000.00, 'Áo khoác denim nam màu tím, size M', 1, GETDATE(), GETDATE(), 1, 1),
(11, 3, 1, 1, 30, 280000.00, 'Áo sơ mi trắng nam, size L', 1, GETDATE(), GETDATE(), 1, 1),
(11, 4, 2, 1, 25, 300000.00, 'Áo sơ mi kẻ nam, size XL', 1, GETDATE(), GETDATE(), 1, 1);
GO
...
VALUES
(9, 1, 1, GETDATE(), GETDATE(), 1000000.00, 5000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 2, 2, GETDATE(), GETDATE(), 2000000.00, 10000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 3, 3, GETDATE(), GETDATE(), 3000000.00, 15000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 4, 4, GETDATE(), GETDATE(), 4000000.00, 20000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 1, 5, GETDATE(), GETDATE(), 5000000.00, 25000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 2, 6, GETDATE(), GETDATE(), 6000000.00, 30000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 3, 7, GETDATE(), GETDATE(), 7000000.00, 35000, 4, GETDATE(), GETDATE(), 1, 1),
(9, 4, 8, GETDATE(), GETDATE(), 8000000.00, 40000, 4, GETDATE(), GETDATE(), 1, 1),
(9, 5, 9, GETDATE(), GETDATE(), 9000000.00, 45000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 6, 2, GETDATE(), GETDATE(), 10000000.00, 50000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 1, 4, GETDATE(), GETDATE(), 11000000.00, 55000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 2, 2, GETDATE(), GETDATE(), 12000000.00, 60000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 3, 3, GETDATE(), GETDATE(), 13000000.00, 65000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 4, 4, GETDATE(), GETDATE(), 14000000.00, 70000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 5, 5, GETDATE(), GETDATE(), 15000000.00, 75000, 4, GETDATE(), GETDATE(), 1, 1),
(9, 6, 6, GETDATE(), GETDATE(), 16000000.00, 80000, 4, GETDATE(), GETDATE(), 1, 1),
(9, 1, 7, GETDATE(), GETDATE(), 17000000.00, 85000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 2, 8, GETDATE(), GETDATE(), 18000000.00, 90000, 1, GETDATE(), GETDATE(), 1, 1),
(9, 3, 9, GETDATE(), GETDATE(), 19000000.00, 95000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 4, 3, GETDATE(), GETDATE(), 20000000.00, 100000, 2, GETDATE(), GETDATE(), 1, 1),
(9, 5, 1, GETDATE(), GETDATE(), 21000000.00, 105000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 6, 2, GETDATE(), GETDATE(), 22000000.00, 110000, 3, GETDATE(), GETDATE(), 1, 1),
(9, 2, 3, GETDATE(), GETDATE(), 23000000.00, 115000, 4, GETDATE(), GETDATE(), 1, 1),
(9, 4, 4, GETDATE(), GETDATE(), 24000000.00, 120000, 4, GETDATE(), GETDATE(), 1, 1);
GO
